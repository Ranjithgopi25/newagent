...
def format_final_article_with_llm(final_article: str, block_types: List[dict] = None) -> str:
    ...
    try:
        ...
        if block_types:
            ...
            block_type_info += "Find and preserve all blocks with type 'bullet_item' as bullet/list items; keep their bullet or icon (•, -, *, etc.) and list structure. Sub headings (level 2/3), sub points, and bullet items list must remain as in the structure.\n"
