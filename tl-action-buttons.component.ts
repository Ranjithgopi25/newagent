...
import { ParagraphEdit, EditorProgressItem } from '../../../../core/models/message.model';
    ...
    <div class="result-section">
      ...
      @if (isSequentialMode && currentEditor) {
        <div class="sequential-progress">
          ...
          @if ((totalEditors ?? 0) > 0 && editorProgressList && editorProgressList.length > 0) {
            <div class="editor-timeline horizontal">
              @for (editor of editorProgressList; track editor.editorId; let i = $index; let last = $last) {
                <div
                  class="timeline-item"
                  [ngClass]="{
...
export class ParagraphEditsConsolidatedComponent implements OnChanges {
  ...
  @Input() editorProgressList?: EditorProgressItem[]; // Editor progress list with status
