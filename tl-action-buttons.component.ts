    ...
    <div class="flow-container" (click)="$event.stopPropagation()">
      ...
      <div class="flow-content">
        <div class="flow-content-wrapper" [class.loading]="isGenerating">
          ...
          <p class="flow-intro">
            This step creates a <strong>Statement of Work (SOW)</strong> draft. Contract type is set automatically — upload your document and add the details below.
          </p>
          ...
          <div class="form-section">
            ...
            <p class="helper-text">
              Upload your proposal, RFP workbook, or scope document so we can align the draft with your goals. Supported formats: .doc, .docx, .pdf, .pptx, .xlsx (max 1 file).
            </p>
            <app-file-upload
              #scopeOfWorkUpload
          ...
          @if (draftHtmlSafe) {
            <div class="draft-result">
              ...
              <p class="draft-result-hint">
                Open the summary to review or edit extracted fields. Applying edits runs the draft step again. Use
                <strong>Generate SOW in chat</strong> to continue in the main chat area.
              </p>
