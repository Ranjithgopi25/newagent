          ...
          <div class="explore-showcase-grid">
            <div class="explore-showcase-card top-left">
              ...
              <p class="explore-showcase-body">
                An AI-powered platform that rapidly synthesizes market, customer, and competitive data into actionable insights and prioritized value creation opportunities.
              </p>
            </div>
            <div class="explore-showcase-card top-center">
              <div class="explore-showcase-title">LCP Advisor</div>
              <p class="explore-showcase-body">
                Equip account leaders with real-time client intelligence, relevant PwC offerings, and connected pipeline insights to shape opportunities and targeted pitches.
              </p>
            </div>
            <div class="explore-showcase-card top-right">
              <div class="explore-showcase-title">AI Opportunity Navigator</div>
              <p class="explore-showcase-body">
                Turn fragmented company data and insights into a prioritized pipeline of AI opportunities, with clear execution paths and continuously refined hypotheses.
              </p>
            </div>
            <div class="explore-showcase-card bottom-left">
              <div class="explore-showcase-title">Workshop Architect</div>
              <p class="explore-showcase-body">
                A structured, repeatable solution for designing and delivering high-impact client workshop experiences using proven methods and curated assets.
              </p>
            </div>
            <div class="explore-showcase-card bottom-right">
              <div class="explore-showcase-title">Deliverable Builder</div>
              <p class="explore-showcase-body">
                Generate and refine client-ready deliverables by combining structured templates with client-specific inputs for consistent, high-quality outputs.
              </p>
            </div>
          </div>
        </div>
