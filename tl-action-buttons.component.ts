        ...
        <div class="reminder-content explore-showcase-content">
          <div class="explore-showcase-grid">
            <div class="explore-showcase-card top-left">
              <div class="explore-showcase-title">Growth Strategy Intelligence Platform</div>
              <p class="explore-showcase-body">
                An AI-powered platform that rapidly synthesizes market, customer, and competitive data into actionable insights, scenario-based strategies, and prioritized value creation opportunities – compressing strategic assessments from weeks to days
              </p>
            </div>
            <div class="explore-showcase-card top-center">
              <div class="explore-showcase-title">LCP Advisor</div>
              <p class="explore-showcase-body">
                Equip account leaders with real-time client intelligence, relevant PwC offerings, and connected pipeline insights – enabling them to identify client needs, shape opportunities, and develop targeted pitches by linking external signals with internal knowledge and systems
              </p>
            </div>
            <div class="explore-showcase-card top-right">
              <div class="explore-showcase-title">AI Opportunity Navigator</div>
              <p class="explore-showcase-body">
                Turn fragmented company data and insights into a prioritized pipeline of AI opportunities, with quantified value and clear execution paths – starting with public data to generate initial outside-in hypotheses and continuously refining opportunities as client data is incorporated
              </p>
            </div>
