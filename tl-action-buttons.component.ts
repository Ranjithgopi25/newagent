...
private exportWordNewLogic(): void {
  ...
  private exportEditContentWord(): void {
    ...
    let exportTitle = extractDocumentTitle(content, this.metadata.topic);
    ...
    if (paragraphEdits && paragraphEdits.length > 0 && originalContent) {
      ...
      exportTitle = extractDocumentTitle(normalizedContent, this.metadata.topic);
    }
    ...
    if (paragraphEdits && paragraphEdits.length > 0) {
      ...
      console.log('[TL Action Buttons] Export Word paragraph_edits block_type distribution:', blockTypeCounts);
    }
  ...
  private exportEditContentPDF(): void {
    ...
    if (paragraphEdits && paragraphEdits.length > 0) {
      ...
      console.log('[TL Action Buttons] Export PDF paragraph_edits block_type distribution:', blockTypeCounts);
    }
