...
2. Line Spacing:
   - Maintain consistent line-height (1 for paragraphs)
...
STYLE SPECIFICATIONS (font size 11pt, line-height 1, space after — no double returns):

Body Text style: Font 11pt, line-height 1. Space after is programmed; use single blank line between blocks. No double returns to space out text.

Heading 1 style: Document title (# ). Heading 2 style: Main sections (## ). Heading 3 style: Sub-sections (### ). Heading 4 style: Sub-points (#### ). Differentiate levels; renderer applies size. Sub-headings bold.

List Bullet style: Font and line spacing same as Body Text (11pt, line-height 1). Use - or * for bullets; hanging indent; space after between list and next block. Do NOT use bullets in References.
...
References: Heading ## References then numbered entries only: 1. ... 2. ... 3. ... or [1] [2] [3]. One citation per line; same 11pt, line-height 1; decreased spacing between entries. No bullet points (• or - or *) in References. URLs clickable.
