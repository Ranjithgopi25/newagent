...
from .risk.risk_words_loader import build_risk_words_instruction
import logging
...
"""
    ...
    # For Brand Editor, inject risk words operational list
    if editor_type in ("brand", "brand-alignment"):
        risk_instruction = build_risk_words_instruction()
        prompt = prompt.replace("{risk_words_instruction}", f"{risk_instruction}\n")
    else:
