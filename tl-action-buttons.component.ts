...
- Preserve inline citation markers and URLs exactly as they appear (format, numbering, links).
- DO NOT invent new citations or reference entries while compressing.
- The References section and all of its entries MUST be preserved; do not remove or alter URLs or titles.
- When deleting or merging sentences, NEVER drop a citation; keep it attached to the nearest surviving sentence that still reflects the same idea.
{FINAL_CHECK}
"""
        },
        {
