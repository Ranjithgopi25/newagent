...
.final-output-content {
  ...
  // Style for lists (proper ordering); tighter spacing for Citations & References
  ul, ol {
    display: block;
    margin: 0.4em 0;
    padding-left: 2em;
  ...
  // Citation/reference URLs: full URL one clickable link when it wraps (no visual “stop” mid-URL)
  .citation-url-link {
    word-break: break-all;
    overflow-wrap: break-word;
    white-space: normal;
