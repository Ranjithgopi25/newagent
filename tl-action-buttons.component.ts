...
- Inline citations: use superscript numerals in brackets: <sup>[ [¹](URL) ]</sup>, <sup>[ [²](URL) ]</sup>, <sup>[ [³](URL) ]</sup> (Unicode ¹²³⁴⁵⁶⁷⁸⁹ — not plain 1,2,3). Keep [Title](URL) as-is. Do not remove or break links.
...
- Citations may appear as:
  * Use superscript for numbered references with superscript numerals in brackets: <sup>[ [¹](https://example.com) ]</sup>, <sup>[ [²](https://example.com) ]</sup> (Unicode ¹²³⁴⁵⁶⁷⁸⁹ — not 1,2,3).
...
- If the original content has numbered citations [¹], [²], continue the numbering sequence for new citations (use superscript numerals in brackets)
...
CRITICAL INSTRUCTION: The research data below contains URL information in metadata fields.
...
Use the following research to enrich and deepen the content
according to the research focus above.

MANDATORY RULES:
- This research is APPROVED for generating NEW content
- At least 80% of newly added content MUST derive from this research
- Every research-derived sentence MUST have EXACTLY ONE citation in format: <sup>[ [ⁿ](URL) ]</sup> (superscript ¹²³⁴⁵⁶⁷⁸⁹ in brackets)
- NEVER use [ⁿ][ᵐ] or multiple citations in one sentence
- Existing citations MUST be preserved
...
Every citation MUST use this EXACT format: <sup>[ [ⁿ](URL) ]</sup> where the number in brackets is a Unicode superscript digit.

WHERE:
- n = citation number as Unicode superscript: ¹, ², ³, ⁴, ⁵, ⁶, ⁷, ⁸, ⁹ (NOT plain 1, 2, 3). So display is [¹], [²], [³].
- URL = complete URL from source metadata
- If no URL exists, use "#" as placeholder

EXAMPLES OF CORRECT FORMAT:
✅ "Companies invest in AI"<sup>[ [¹](https://www.pwc.com/article.html) ]</sup>
✅ "Internal data shows"<sup>[ [²](https://connectedsource.pwcinternal.com/doc) ]</sup>
✅ "Benchmarks indicate"<sup>[ [³](#) ]</sup>

EXAMPLES OF FORBIDDEN FORMAT:
❌ "Companies invest in AI" [1] or [¹] without link
❌ "Companies invest in AI"[1]
❌ "Companies invest in AI"<sup>[1]</sup>
❌ "Companies invest in AI"<sup>[[¹](url)]</sup> (no spaces)
❌ "Text"<sup>[ [¹](url) ]</sup><sup>[ [²](url) ]</sup>
...
- All factual additions must include citations in <sup>[ [ⁿ](URL) ]</sup> format (superscript numeral ¹²³⁴⁵⁶⁷⁸⁹ in brackets).
...
- ZERO means acceptable patterns: [¹][²], [¹,²], [¹][²][³], etc. (use superscript numerals in brackets).
...
Step 3: Ensure each citation uses <sup>[ [ⁿ](URL) ]</sup> format (superscript ¹²³⁴⁵⁶⁷⁸⁹ in brackets)

CRITICAL EXAMPLES:

❌ ABSOLUTELY FORBIDDEN:
"AI solutions deliver 15-25% lift and improve forecasting"<sup>[ [⁵](url1) ]</sup><sup>[ [⁶](url2) ]</sup>

✅ REQUIRED CORRECTION:
"AI solutions deliver 15-25% lift"<sup>[ [⁵](url1) ]</sup>. "These solutions also improve forecasting"<sup>[ [⁶](url2) ]</sup>.

❌ ABSOLUTELY FORBIDDEN:
"Companies see improved accuracy"[³][⁷]

✅ REQUIRED CORRECTION:
"Companies see improved accuracy"<sup>[ [³](url) ]</sup>
(Select [³] or [⁷], use ONLY one, format correctly with superscript in bracket)

SELF-CHECK BEFORE SUBMITTING:
□ Did I scan EVERY sentence for multiple citations?
□ Did I remove ALL instances of [ⁿ][ᵐ] or [ⁿ,ᵐ] patterns?
□ Did I convert ALL citations to <sup>[ [ⁿ](URL) ]</sup> format (superscript ¹²³⁴⁵⁶⁷⁸⁹ in brackets)?
...
Format: <sup>[ [ⁿ](COMPLETE_URL) ]</sup> (use Unicode superscript ¹, ², ³, ⁴... in the bracket)

Examples:
- Public URL: <sup>[ [¹](https://www.pwc.com/us/en/library/article.html) ]</sup>
- Internal URL: <sup>[ [²](https://connectedsource.pwcinternal.com/doc/abc123) ]</sup>
- No URL: <sup>[ [³](#) ]</sup>
...
CITATION FORMAT:
□ Every citation uses <sup>[ [ⁿ](URL) ]</sup> format with superscript numerals (¹²³⁴⁵⁶⁷⁸⁹) in brackets
□ NO citations use plain [1] or [2] format
□ NO citations use <sup>[1]</sup> format

SINGLE CITATION RULE:
□ NO sentence contains [ⁿ][ᵐ] pattern
...
- ANY sentence contains [ⁿ][ᵐ] or [ⁿ,ᵐ] (multiple citations)
- ANY citation uses [1] or [2] instead of <sup>[ [¹](URL) ]</sup> / <sup>[ [²](URL) ]</sup> (must use superscript ¹²³⁴⁵⁶⁷⁸⁹ in brackets)
