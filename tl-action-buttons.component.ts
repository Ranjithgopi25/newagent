...
from app.common.document_utils import extract_text_from_pdf, extract_text_from_docx,extract_text_from_txt, extract_text_from_pptx,extract_text_from_image,extract_text_from_xlsx, convert_word_bytes_to_pdf
    ...
    try:
        ...
        try:
            if file_extension == 'pdf':
                ...
                extracted_text = extract_text_from_pdf(pdf_bytes, max_chars=None)
