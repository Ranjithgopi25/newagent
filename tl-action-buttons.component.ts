...
.message-text {
  ...
  // Edit content final output: paragraphs normal weight (not bold), match PDF
  .result-section p,
  .revised-content-formatted p {
    font-weight: 400;
  }

  // Citation links in edit content: blue, underlined, clickable (match PDF)
  .citation-link {
    color: #0066cc;
