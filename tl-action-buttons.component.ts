...
CRITICAL: You MUST preserve markdown citation links in their original format.

Citation links appear in citation sections (Sources, References, numbered citations) and MUST remain in markdown format: [Title](URL)

PRESERVATION RULES:
- DO NOT convert markdown citation links `[Title](URL)` to HTML `<a href="URL">Title</a>`
- DO NOT convert markdown citation links `[Title](URL)` to plain text `Title`
- DO NOT remove URLs from citation links
- DO NOT modify the markdown link syntax `[Title](URL)`
- Preserve the exact format: square brackets around title, parentheses around URL

Examples of CORRECT preservation:
- Input: `1. [PwC Global CEO Survey](https://www.pwc.com/ceosurvey)`
- Output: `1. [PwC Global CEO Survey](https://www.pwc.com/ceosurvey)` (unchanged)
...
- Any paragraph containing citation patterns with markdown links
...
- All markdown citation links `[Title](URL)` are preserved in their original format
- No citation URLs have been removed or converted to HTML/plain text
