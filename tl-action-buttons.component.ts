      ...
      <!-- Per-paragraph feedback UI -->
        ...
        @if (isSequentialMode && currentEditor) {
          <div class="sequential-progress">
            ...
            @if (editorProgressList && editorProgressList.length > 0) {
                ...
                @for (editor of editorProgressList; track editor.editorId; let i = $index; let last = $last) {
                  <div
                    ...
                    [ngClass]="{
                      ...
                      'active': editor.status === 'processing',
                      'loading': editor.status === 'processing' && isGenerating,
                  ...
                  >
                    ...
                    <div class="timeline-status">
                      @if (editor.status === 'completed') {
                        @if (paragraphFeedbackData.length > 0 && !allParagraphsDecided) {
                          Review Pending
                        } @else {
                          Completed
                        }
