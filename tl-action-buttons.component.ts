...
Use EXACT format: <sup>[ ⁿ ]</sup>(ACTUAL_URL) — n = Unicode superscript: ¹ ² ³ ⁴ ⁵ ⁶ ⁷ ⁸ ⁹ (NOT plain 1, 2, 3). Put the REAL URL in parentheses immediately after the closing </sup>. Both the superscript and the URL will render as clickable links.
...
- "(Ref. 1; Ref. 2)" → <sup>[ ¹ ]</sup><sup>[ ² ]</sup>(url) or separate tags if different URLs
...
- Use <sup>[ ⁿ ]</sup>(actual_url) — superscript and URL both render as clickable
