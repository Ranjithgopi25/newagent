...
def convert_into_frontend(
    ...
    # For combined steps, feedback is stored under development_content / line_copy
    def _feedback_keys_for_editor(e: str):
        if e == "development+content":
            return ["development_content"]
        if e == "line+copy":
            return ["line_copy"]
    ...
    for i, block in enumerate(result.blocks):
        ...
        if current_editor:
            ...
            # Show all feedback (for final view), including combined steps
            for editor_name in ["development", "content", "copy", "line", "brand", "development_content", "line_copy"]:
